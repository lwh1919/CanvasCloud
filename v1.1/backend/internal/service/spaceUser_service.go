...
import (
	...
	reqSpaceUser "backend/internal/model/request/spaceuser"
	resSpace "backend/internal/model/response/space"
	resSpaceUser "backend/internal/model/response/spaceuser"
...
func (s *SpaceUserService) AddSpaceUser(req reqSpaceUser.SpaceUserAddRequest) (uint64, *ecode.ErrorWithCode) {
	...
	casbin.UpdateUserRoleInDomain(req.UserID, consts.SPACEROLE_VIEWER, dom)
...
func (s *SpaceUserService) EditSpaceUser(req *reqSpaceUser.SpaceUserEditRequest) (bool, *ecode.ErrorWithCode) {
	...
	casbin.UpdateUserRoleInDomain(oldSpaceUser.UserID, req.SpaceRole, domain)
	return true, nil
}
